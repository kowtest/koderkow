...
This is my packages that houses functions I find myself frequently using. I am also using this package to learn about building flexible and robust packages!
...
Number with only 2 numeric places (tens), then it will round on the tens position value:
